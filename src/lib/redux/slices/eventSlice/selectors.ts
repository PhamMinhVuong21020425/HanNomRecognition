...
// in the slice file.
export const selectIsUploadModal = (state: ReduxState) =>
  state.event.isUploadModal;

export const selectIsOpenDescript = (state: ReduxState) =>
  state.event.isOpenDescript;
