      ...
      <div className="footer-content">
        ...
        <div className="information">
          <div className="top-info">
            ...
            <div>University of Engineering and Technology - VNU</div>
          </div>
          <div>Address: Room No. 301 - E3 Building, 144 - Xuan Thuy</div>
          <div>Cau Giay, Ha Noi, Viet Nam</div>
          <div>Telephone: (024)37547064. Fax: (024)37547460</div>
        ...
        <div className="contact-social">
          ...
          <div className="logo">
            <a
              target="blank"
              href="https://www.facebook.com/pham.vuong.236093"
            ...
            <a
              ...
              target="blank"
              href="https://www.youtube.com/@truongaihoccongnghe-hqghn1447/featured"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                x="0px"
