...
function Contact() {
  ...
  useEffect(() => {
    document.title = intl.formatMessage({ id: 'metadata.contact.title' });
  }, [locale]);
          ...
          <div className="contact-body">
            ...
            <div className="information">
              ...
              <div className="header-data">
                ...
                <div className="script">Điện thoại: 024.37547.461</div>
              </div>
              <div className="header-data">
                <div className="icon">
                  <svg
                ...
                <div className="script">Fax: 024.37547.460;</div>
              </div>
              <div className="header-data">
                <div className="icon">
                  <svg
                ...
                <div className="script">Email: ctsv_dhcn@vnu.edu.vn</div>
              </div>
              <div className="header-data">
                <div className="icon">
                  <FaFacebook />
